...
const FeaturedPost = () => {
  return (
    <div className="grid grid-cols-21 md:grid-cols-2 gap-8 items-center">
      <div className="flex-1 flex-col items-start justify-between h-full flex border-t-2 border-b-2 border-[#787878]">
      ...
      <Image src={"/images/featuredPost.png"} height={200} width={300} alt="featured post" className="flex-1 hidden md:inline w-full" />
